...
const TestLocationForm = ({ visitInfo, setVisitInfo, handleError, handleBack }: Props) => {
  ...
  const handleSearch = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const filteredLocations = locations.filter((location) => location.hospital_name.match(regex));
